export default {
  ...
  build: {
    ...
    site: {
      publicPath:
        (typeof window === 'undefined' && process.env.PUBLIC_PATH) || '/zwvant/',
    },
    vetur: {
      tagPrefix: 'van-',
    },
  ...
  site: {
    ...
    versions: [
      { label: 'v1', link: '/zwvant/v1/' },
      { label: 'v2', link: '/zwvant/v2/' },
      { label: 'v3', link: '/zwvant/v3/' },
    ],
    baiduAnalytics: {
...
location.href = location.href.replace('youzan.github.io', 'zwvant-ui.github.io');
}
</script>
`,
    locales: {
      'zh-CN': {
        ...
        logo: 'https://fastly.jsdelivr.net/npm/@zwvant/assets/logo.png',
        langLabel: '中',
        links: [
          {
            logo: 'https://fastly.jsdelivr.net/npm/@zwvant/assets/weapp.svg',
            url: 'https://zwvant-contrib.gitee.io/zwvant-weapp/',
          },
          {
            logo: 'https://fastly.jsdelivr.net/npm/@zwvant/assets/github.svg',
            url: 'https://github.com/zwvant-ui/zwvant',
          },
        ],
        nav: [
          {
